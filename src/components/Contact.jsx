      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
          ...
          <div ref={infoRef} className="flex flex-col justify-center">
            ...
            <p className="text-blue-200 mb-10 text-lg">¿Tienes un proyecto en mente? Hablemos. Nuestro equipo está listo para ayudarte a llevar tus ideas al siguiente nivel.</p>
            
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                <div className="bg-white/10 p-3 rounded-full"><MapPin className="text-blue-400" /></div>
                <div>
                  <h4 className="font-bold">Ubicación</h4>
                  <p className="text-gray-300">San Isidro, Lima, Perú</p>
                </div>
              </div>
              <div className="flex items-center gap-4">
                <div className="bg-white/10 p-3 rounded-full"><Phone className="text-blue-400" /></div>
                <div>
              ...
              <div className="flex items-center gap-4">
                <div className="bg-white/10 p-3 rounded-full"><Mail className="text-blue-400" /></div>
                <div>
                  <h4 className="font-bold">Correo Electrónico</h4>
                  <p className="text-gray-300">hola@sharkcorp.com</p>
                </div>
              </div>
            </div>
          </div>
          ...
          {/* Form */}
          <div ref={formRef} className="bg-white rounded-3xl p-8 lg:p-12 shadow-xl border border-gray-100 relative">
            {isSuccess ? (
              <div ref={successRef} className="absolute inset-0 bg-white rounded-3xl flex flex-col items-center justify-center p-8 z-20">
                <img src={logo} alt="SharkCorp Logo" className="w-40 h-40 mb-4 drop-shadow-xl object-contain" />
                <CheckCircle size={64} className="text-[#000047] mb-6" />
                <h3 className="text-3xl font-black text-[#000047] mb-2 text-center">¡Mensaje Enviado!</h3>
                <p className="text-gray-500 text-center font-medium">Gracias por contactarnos. Nuestro equipo se pondrá en contacto contigo muy pronto.</p>
                <button 
                  onClick={() => { setIsSuccess(false); setFormData({ name: '', email: '', message: '' }); }}
            ...
            <h3 className="text-2xl font-bold text-shark-navy mb-8">Envíanos un mensaje</h3>
            <form className="space-y-6" onSubmit={handleSubmit} noValidate>
              ...
              <div>
                ...
                ></textarea>
                {errors.message && <p className="text-red-500 text-xs font-bold mt-1 pl-1">{errors.message}</p>}
              </div>
              <button type="submit" disabled={isSubmitting} className="relative w-full py-4 rounded-xl flex items-center justify-center gap-2 transition-all duration-300 hover:scale-[1.02] hover:shadow-xl hover:shadow-[#3084ff]/20 cursor-pointer group overflow-hidden bg-[#000047] text-white font-bold z-10 disabled:opacity-80 disabled:cursor-not-allowed">
                {isSubmitting ? (
                  <>
                  ...
                  <>
                    ...
                    <div className="absolute inset-[2px] bg-[#000047] rounded-[10px] -z-10"></div>
                    <span className="relative z-10 flex items-center gap-2">Enviar Mensaje <Send size={20} className="group-hover:translate-x-1 transition-transform duration-300" /></span>
                  </>
                )}
              </button>
            </form>
